...
function loadSVGSprite() {
  ...
  div.innerHTML = `<svg class="svg-sprite"><defs>
    ...
    <symbol id="icon-headphones" viewBox="0 0 24 24"><path d="M3 18v-6a9 9 0 0 1 18 0v6" fill="none" stroke="currentColor" stroke-width="2"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z" fill="none" stroke="currentColor" stroke-width="2"/></symbol>
    <symbol id="icon-phone" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" fill="none" stroke="currentColor" stroke-width="2"/></symbol>
    <symbol id="icon-pen-nib" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5z" fill="none" stroke="currentColor" stroke-width="2"/><path d="M2 17l10 5 10-5" fill="none" stroke="currentColor" stroke-width="2"/><path d="M2 12l10 5 10-5" fill="none" stroke="currentColor" stroke-width="2"/></symbol>
    <symbol id="icon-lightbulb" viewBox="0 0 24 24"><path d="M9 21h6" stroke="currentColor" stroke-width="2"/><path d="M12 3a6 6 0 0 1 6 6c0 2.22-1.2 4.15-3 5.19V17H9v-2.81C7.2 13.15 6 11.22 6 9a6 6 0 0 1 6-6z" fill="none" stroke="currentColor" stroke-width="2"/></symbol>
    <symbol id="icon-flask" viewBox="0 0 24 24"><path d="M9 3h6v8l3 9H6l3-9V3z" fill="none" stroke="currentColor" stroke-width="2"/><line x1="9" y1="3" x2="15" y2="3" stroke="currentColor" stroke-width="2"/><line x1="6" y1="14" x2="18" y2="14" stroke="currentColor" stroke-width="2"/></symbol>
