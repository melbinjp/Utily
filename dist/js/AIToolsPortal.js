...
export class AIToolsPortal {
    ...
    getToolCategory(tool) {
        ...
        if (title.includes('chat') || title.includes('ai') || description.includes('ai') || description.includes('transcription')) return 'ai';
        if (title.includes('audio') || title.includes('video') || title.includes('3d') || title.includes('voice')) return 'media';
        return 'utility';
    }
